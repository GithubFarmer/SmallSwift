...
class VideoPlayerView: UIView {
    ...
    var isLive: Bool? {
        didSet {
            if isLive! {
//                GestureControlModel.sharedInstance.doubleTap.isEnabled = true
                GestureControlModel.sharedInstance.pinchGR.isEnabled = false
                GestureControlModel.sharedInstance.panGR.isEnabled = false
                ControlModel.sharedInstance.slider.isHidden = true
                ControlModel.sharedInstance.totalDurationLabel.isHidden = true
            }else{
//                GestureControlModel.sharedInstance.doubleTap.isEnabled = true
                GestureControlModel.sharedInstance.pinchGR.isEnabled = true
                GestureControlModel.sharedInstance.panGR.isEnabled = true
                ControlModel.sharedInstance.slider.isEnabled = true
                ControlModel.sharedInstance.slider.isHidden = false
                ControlModel.sharedInstance.totalDurationLabel.isHidden = false
            }
        }
    }
